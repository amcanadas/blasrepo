...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contenido.resultadoAprendizaje'
        db.delete_column(u'normativa_contenido', 'resultadoAprendizaje_id')

        # Adding field 'Contenido.materia'
        db.add_column(u'normativa_contenido', 'materia',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['normativa.Materia']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Contenido.resultadoAprendizaje'
        db.add_column(u'normativa_contenido', 'resultadoAprendizaje',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['normativa.ResultadoAprendizaje']),
                      keep_default=False)

        # Deleting field 'Contenido.materia'
        db.delete_column(u'normativa_contenido', 'materia_id')
